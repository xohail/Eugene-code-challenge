...
@section('content')
    <div class="container mx-auto px-4">
        ...
        <div class="flex items-center justify-between mb-4">
            <h1 class="text-2xl font-bold">Duplicate doctors</h1>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                                ...
                                @foreach($potentialDuplicates as $duplicate)
                                    <tr>
                                        ...
                                        <td class="border px-4 py-2">
                                            <form action="{{ route('duplicates.doctors_merge') }}" method="POST">
                                                @csrf
        ...
        @else
            <div class="flex items-center justify-between mb-4">
                <h1 class="text-2xl font-bold">No duplicate doctors found!!</h1>
            </div>
        @endif
    </div>
